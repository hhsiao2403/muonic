...
#
# Created: Wed Mar 17 13:24:38 2010
...
class Ui_Hauptfenster(object):
    def setupUi(self, Hauptfenster):
        ...
        QtCore.QObject.connect(self.checkBox,QtCore.SIGNAL("stateChanged(int)"),self.actionAutoAktualisieren)
        QtCore.QObject.connect(self.pushButton_3,QtCore.SIGNAL("clicked()"),self.actionAktualisieren)
        QtCore.QObject.connect(self.pushButton,QtCore.SIGNAL("clicked()"),self.actionSend_clicked)
        QtCore.QObject.connect(self.action_ffnen,QtCore.SIGNAL("activated()"),self.action_ffnen_clicked)
        QtCore.QObject.connect(self.actionNeu,QtCore.SIGNAL("activated()"),self.actionNeu_clicked)
        ...
        QtCore.QObject.connect(self.lineEdit,QtCore.SIGNAL("returnPressed()"),self.actionSend_clicked)
...
#class Hauptfenster_Anwendung(self,  Hauptfenster):
